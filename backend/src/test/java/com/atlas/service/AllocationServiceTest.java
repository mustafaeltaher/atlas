...
public class AllocationServiceTest {
        ...
        void getDistinctAllocationTypes_noFilter_shouldIncludeBench() {
                ...
                org.springframework.data.domain.Page<Employee> benchPage = new org.springframework.data.domain.PageImpl<>(
        ...
        void getGroupedAllocations_prospectFilterWithMonth_shouldOnlyReturnEmployeesWithProspectInSelectedMonth() {
                ...
                // Employee #1: Has PROSPECT allocation in February 2026 (startDate: Feb 1,
                // endDate: Feb 28)
                ...
                // Employee #2: Has PROSPECT allocation in July 2026 (startDate: Jul 1, endDate:
                // Jul 31)
                ...
                // Mock employeeRepository to return only Employee #2 when filtering for July +
                // PROSPECT
                // The key assertion: PROSPECT status check should use selected month (July),
                // not any month
                when(employeeRepository.findAll(any(org.springframework.data.jpa.domain.Specification.class),
                                any(org.springframework.data.domain.Pageable.class)))
                                .thenReturn(new org.springframework.data.domain.PageImpl<>(
                                                java.util.List.of(prospectInJul))); // Only employee with PROSPECT in
                                                                                    // July
        ...
        void getGroupedAllocations_maternityFilterWithMonth_shouldOnlyReturnEmployeesWithMaternityInSelectedMonth() {
                ...
                // Employee #1: Has MATERNITY allocation in March 2026 (startDate: Mar 1,
                // endDate: Mar 31)
                ...
                // Employee #2: Has MATERNITY allocation in August 2026 (startDate: Aug 1,
                // endDate: Aug 31)
                ...
                // Mock employeeRepository to return only Employee #2 when filtering for August
                // + MATERNITY
                when(employeeRepository.findAll(any(org.springframework.data.jpa.domain.Specification.class),
                                any(org.springframework.data.domain.Pageable.class)))
                                .thenReturn(new org.springframework.data.domain.PageImpl<>(
                                                java.util.List.of(maternityInAug))); // Only employee with MATERNITY in
                                                                                     // August
        ...
        void getGroupedAllocations_vacationFilterWithMonth_shouldOnlyReturnEmployeesWithVacationInSelectedMonth() {
                ...
                // Employee #1: Has VACATION allocation in April 2026 (startDate: Apr 1,
                // endDate: Apr 30)
                ...
                // Employee #2: Has VACATION allocation in September 2026 (startDate: Sep 1,
                // endDate: Sep 30)
                ...
                // Mock employeeRepository to return only Employee #2 when filtering for
                // September + VACATION
                when(employeeRepository.findAll(any(org.springframework.data.jpa.domain.Specification.class),
                                any(org.springframework.data.domain.Pageable.class)))
                                .thenReturn(new org.springframework.data.domain.PageImpl<>(
                                                java.util.List.of(vacationInSep))); // Only employee with VACATION in
                                                                                    // September
        ...
        void getGroupedAllocations_prospectFilterWithDateRangeOverlap_shouldIncludeOverlappingAllocations() {
                ...
                // Employee: Has PROSPECT allocation from June 1 to August 31, 2026 (spans 3
                // months)
                ...
                // Date range overlap: startDate (Jun 1) <= lastDayOfMonth (Jul 31) AND endDate
                // (Aug 31) >= firstDayOfMonth (Jul 1)
                assertThat(result.getContent()).hasSize(1);
        ...
        void getGroupedAllocations_prospectFilterWithEndedAllocation_shouldExcludeEmployees() {
                ...
                // Should NOT appear when filtering for July 2026 (allocation ended before
                // selected month)
                ...
                // Mock employeeRepository to return empty list (employee should be filtered
                // out)
                when(employeeRepository.findAll(any(org.springframework.data.jpa.domain.Specification.class),
                                any(org.springframework.data.domain.Pageable.class)))
                                .thenReturn(new org.springframework.data.domain.PageImpl<>(
        ...
        void getManagersForAllocations_withProspectTypeAndMonth_shouldReturnManagersInSelectedMonth() {
                ...
                // This simulates that there ARE employees with PROSPECT allocations for this
                // manager in July 2026
                ...
                java.util.List<java.util.Map<String, Object>> managers = allocationService.getManagersForAllocations(
        ...
        // ==================== Month-by-Month Allocation Tests ====================
        ...
        void createAllocation_monthByMonthMode_createsIndividualMonthlyAllocations() {
                // Given
                com.atlas.dto.MonthlyAllocationDTO month1 = com.atlas.dto.MonthlyAllocationDTO.builder().year(2026)
                                .month(1).percentage(50).build();
                com.atlas.dto.MonthlyAllocationDTO month2 = com.atlas.dto.MonthlyAllocationDTO.builder().year(2026)
                                .month(2).percentage(75).build();
                AllocationDTO requestDto = AllocationDTO.builder()
                                .employeeId(1L)
                                .projectId(1L)
                                .allocationType(Allocation.AllocationType.PROJECT)
                                .startDate(LocalDate.of(2026, 1, 1))
                                .endDate(LocalDate.of(2026, 2, 28))
                                .monthlyAllocations(java.util.List.of(month1, month2))
                                .build();
                ...
                when(allocationRepository.findByIdWithDetails(any())).thenReturn(Optional.of(savedAlloc));

                // When
                allocationService.createAllocation(requestDto);

                // Then
                org.mockito.Mockito.verify(monthlyAllocationRepository, org.mockito.Mockito.times(2))
                                .save(any(com.atlas.entity.MonthlyAllocation.class));
        }

        @Test
        @DisplayName("createAllocation - Single percentage mode creates uniform monthly allocations")
        void createAllocation_singlePercentageMode_appliesUniformPercentage() {
                ...
                org.mockito.Mockito.verify(monthlyAllocationRepository, org.mockito.Mockito.times(3))
                                .save(any(com.atlas.entity.MonthlyAllocation.class));
        }

        @Test
        @DisplayName("createAllocation - Month-by-month mode validates percentage range")
        void createAllocation_monthByMonthWithInvalidPercentage_throwsValidationException() {
                // Given
                com.atlas.dto.MonthlyAllocationDTO invalidMonth = com.atlas.dto.MonthlyAllocationDTO.builder()
                                .year(2026).month(1).percentage(150).build();
                AllocationDTO requestDto = AllocationDTO.builder()
                                .employeeId(1L)
                                .projectId(1L)
                                .allocationType(Allocation.AllocationType.PROJECT)
                                .startDate(LocalDate.of(2026, 1, 1))
                                .endDate(LocalDate.of(2026, 1, 31))
                                .monthlyAllocations(java.util.List.of(invalidMonth))
                                .build();

                when(employeeRepository.findById(1L)).thenReturn(Optional.of(employee));
                when(projectRepository.findById(1L)).thenReturn(Optional.of(project));
                when(allocationRepository.save(any(Allocation.class))).thenReturn(new Allocation());
        ...
        @Test
        @DisplayName("updateAllocation - Month-by-month mode updates selected months only")
        void updateAllocation_monthByMonthMode_updatesSelectedMonthsOnly() {
                // Given
                ...
                com.atlas.dto.MonthlyAllocationDTO updateMonth = com.atlas.dto.MonthlyAllocationDTO.builder().year(2026)
                                .month(1).percentage(60).build();
                AllocationDTO requestDto = AllocationDTO.builder()
                                .monthlyAllocations(java.util.List.of(updateMonth))
                                .build();

                when(allocationRepository.findById(100L)).thenReturn(Optional.of(existingAlloc));
                when(allocationRepository.save(any(Allocation.class))).thenReturn(existingAlloc);

                com.atlas.entity.MonthlyAllocation existingMonthly = com.atlas.entity.MonthlyAllocation.builder()
                                .id(1L)
                                .year(2026)
                                .month(1)
                                .percentage(40)
                                .build();
                when(monthlyAllocationRepository.findByAllocationIdAndYearAndMonth(100L, 2026, 1))
                                .thenReturn(Optional.of(existingMonthly));

                // When
                allocationService.updateAllocation(100L, requestDto);

                // Then
                org.mockito.Mockito.verify(monthlyAllocationRepository, org.mockito.Mockito.times(1))
                                .save(existingMonthly);
                assertThat(existingMonthly.getPercentage()).isEqualTo(60);
        }

        @Test
        @DisplayName("updateAllocation - Single percentage mode updates all months uniformly")
        void updateAllocation_singlePercentageMode_updatesAllMonthsUniformly() {
                // Given
                Allocation existingAlloc = Allocation.builder()
                                .id(100L)
                                .employee(employee)
                ...
                when(monthlyAllocationRepository.findByAllocationIdAndYearAndMonth(eq(100L), any(Integer.class),
                                any(Integer.class)))
                                .thenReturn(Optional.empty());
        ...
        @Test
        @DisplayName("updateAllocation - Month-by-month mode validates percentage range")
        void updateAllocation_monthByMonthMode_validatesPercentageRange() {
                // Given
                Allocation existingAlloc = createBasicAllocation();
                com.atlas.dto.MonthlyAllocationDTO invalidMonth = com.atlas.dto.MonthlyAllocationDTO.builder()
                                .year(2026).month(1).percentage(0).build();
                AllocationDTO requestDto = AllocationDTO.builder().monthlyAllocations(java.util.List.of(invalidMonth))
                                .build();

                when(allocationRepository.findById(1L)).thenReturn(Optional.of(existingAlloc));

                // When/Then
                org.junit.jupiter.api.Assertions.assertThrows(RuntimeException.class,
                                () -> allocationService.updateAllocation(1L, requestDto));
        }

        @Test
        @DisplayName("updateAllocation - Single percentage mode ignores past months")
        void updateAllocation_singlePercentage_ignoresPastMonths() {
                // Given
                int currentYear = LocalDate.now().getYear();
                int currentMonth = LocalDate.now().getMonthValue();

                // Create an allocation that started 2 months ago and ends 2 months from now
                LocalDate startDate = LocalDate.now().minusMonths(2).withDayOfMonth(1);
                LocalDate endDate = LocalDate.now().plusMonths(2).withDayOfMonth(28);
                ...
                AllocationDTO requestDto = AllocationDTO.builder()
                                .currentMonthAllocation(75) // Update to 75%
                                .build();

                when(allocationRepository.findById(101L)).thenReturn(Optional.of(existingAlloc));
                when(allocationRepository.save(any(Allocation.class))).thenReturn(existingAlloc);

                // Mock finding no existing monthly allocations
                when(monthlyAllocationRepository.findByAllocationIdAndYearAndMonth(eq(101L), any(Integer.class),
                                any(Integer.class)))
                                .thenReturn(Optional.empty());

                // When
                allocationService.updateAllocation(101L, requestDto);

                // Then
                // 5 months total (2 past, 1 current, 2 future).
                // It should ONLY save the current and future months (3 total saves).
                org.mockito.Mockito.verify(monthlyAllocationRepository, org.mockito.Mockito.times(3))
                                .save(any(com.atlas.entity.MonthlyAllocation.class));
        }

        @Test
        @DisplayName("updateAllocation - Switch from single to month-by-month persists correctly")
        void updateAllocation_switchToMonthByMonth_updatesMonthlyAllocations() {
                ...
                // Pass missing monthly allocations (smart update limits updates to provided
                // months)
                com.atlas.dto.MonthlyAllocationDTO newMonth = com.atlas.dto.MonthlyAllocationDTO.builder().year(2026)
                                .month(2).percentage(100).build();
                AllocationDTO requestDto = AllocationDTO.builder().monthlyAllocations(java.util.List.of(newMonth))
                                .build();

                when(allocationRepository.findById(100L)).thenReturn(Optional.of(existingAlloc));
                when(allocationRepository.save(any(Allocation.class))).thenReturn(existingAlloc);
                when(monthlyAllocationRepository.findByAllocationIdAndYearAndMonth(100L, 2026, 2))
                                .thenReturn(Optional.empty());
        ...
        @Test
        @DisplayName("updateAllocation - Updating PROSPECT allocation without changing type succeeds")
        void updateAllocation_prospectAllocationWithoutType_updatesSuccessfully() {
                // Given
                Allocation existingAlloc = Allocation.builder()
                                .id(105L)
                                .employee(employee)
                ...
                com.atlas.dto.MonthlyAllocationDTO updateMonth = com.atlas.dto.MonthlyAllocationDTO.builder().year(2026)
                                .month(5).percentage(80).build();

                // DTO does not specify allocationType (representing a pure percentage update)
                AllocationDTO requestDto = AllocationDTO.builder()
                                .monthlyAllocations(java.util.List.of(updateMonth))
                                .build();

                when(allocationRepository.findById(105L)).thenReturn(Optional.of(existingAlloc));
                when(allocationRepository.save(any(Allocation.class))).thenReturn(existingAlloc);
                ...
                com.atlas.entity.MonthlyAllocation existingMonthly = com.atlas.entity.MonthlyAllocation.builder()
                                ...
                                .percentage(100)
                                .build();
                when(monthlyAllocationRepository.findByAllocationIdAndYearAndMonth(105L, 2026, 5))
                                .thenReturn(Optional.of(existingMonthly));

                // When
                allocationService.updateAllocation(105L, requestDto);

                // Then
                org.mockito.Mockito.verify(monthlyAllocationRepository, org.mockito.Mockito.times(1))
                                .save(existingMonthly);
                assertThat(existingMonthly.getPercentage()).isEqualTo(80);
        }

        @Test
        @DisplayName("updateAllocation - Switch from month-by-month to single overwrites all months uniformly")
        void updateAllocation_switchToSinglePercentage_unifiesMonthlyAllocations() {
                ...
                Allocation existingAlloc = Allocation.builder()
                                ...
                                .allocationType(Allocation.AllocationType.PROJECT)
                                .startDate(LocalDate.now().plusMonths(1).withDayOfMonth(1))
                                .endDate(LocalDate.now().plusMonths(3).withDayOfMonth(28))
                                .build();

                AllocationDTO requestDto = AllocationDTO.builder().currentMonthAllocation(50).build();
        ...
        @Test
        @DisplayName("createAllocation - Month-by-month mode with missing months throws validation exception")
        void createAllocation_monthByMonthWithMissingMonths_throwsValidationException() {
                // Given
                com.atlas.dto.MonthlyAllocationDTO invalidMonth = com.atlas.dto.MonthlyAllocationDTO.builder()
                                .year(2026).month(1).percentage(null).build();
                AllocationDTO requestDto = AllocationDTO.builder()
                                .employeeId(1L)
                                .projectId(1L)
                                .allocationType(Allocation.AllocationType.PROJECT)
        ...
        @Test
        @DisplayName("updateAllocation - Extend date range adds new monthly allocations")
        void updateAllocation_extendDateRange_addsNewMonthlyAllocations() {
                // Given
                Allocation existingAlloc = Allocation.builder()
                                .id(100L)
                                .employee(employee)
                ...
                com.atlas.dto.MonthlyAllocationDTO newMonth = com.atlas.dto.MonthlyAllocationDTO.builder()
                                .year(2026).month(2).percentage(50).build();
                AllocationDTO requestDto = AllocationDTO.builder().monthlyAllocations(java.util.List.of(newMonth))
                                .build();
        ...
        @Test
        @DisplayName("getAllocationsByEmployee - Should use provided year and month for currentMonthAllocation")
        void getAllocationsByEmployee_withSpecificMonth_returnsCorrectPercentages() {
                // Given
                com.atlas.entity.User mockUser = new com.atlas.entity.User();
                mockUser.setId(1L);
                mockUser.setEmployee(employee);
                ...
                when(allocationRepository.findByEmployeeIdWithDetails(1L))
                                .thenReturn(java.util.List.of(existingAlloc));

                // We are requesting year 2026, month 2 (February). Mock returning a 60%
                // allocation for this specific month.
                com.atlas.entity.MonthlyAllocation mockMonthlyAlloc = new com.atlas.entity.MonthlyAllocation();
                mockMonthlyAlloc.setId(500L);
                mockMonthlyAlloc.setAllocation(existingAlloc);
                mockMonthlyAlloc.setPercentage(60);

                when(monthlyAllocationRepository.findByAllocationIdsAndYearAndMonth(
                                java.util.List.of(100L), 2026, 2))
                                .thenReturn(java.util.List.of(mockMonthlyAlloc));

                // When
                java.util.List<AllocationDTO> dtos = allocationService.getAllocationsByEmployee(1L, 2026, 2, mockUser);

                // Then
                assertThat(dtos).hasSize(1);
                assertThat(dtos.get(0).getCurrentMonthAllocation()).isEqualTo(60);
                assertThat(dtos.get(0).getAllocationPercentage()).isEqualTo(60.0);
        }

        @Test
        @DisplayName("updateAllocation - Reduce date range removes out of range monthly allocations")
        void updateAllocation_reduceDateRange_removesOutOfRangeMonthlyAllocations() {
                // Note: The spec explicitly states "Backend does NOT delete any
                // MonthlyAllocation records (no date range changes in edit mode)".
                // However, the test name is mandatory. We implement it to verify that no
                // records are removed (0 deletes).
                // Given
                Allocation existingAlloc = Allocation.builder()
                                .id(100L)
                                .employee(employee)
                ...
                com.atlas.dto.MonthlyAllocationDTO updateMonth = com.atlas.dto.MonthlyAllocationDTO.builder()
                                .year(2026).month(1).percentage(100).build();
                AllocationDTO requestDto = AllocationDTO.builder().monthlyAllocations(java.util.List.of(updateMonth))
                                .build();
                ...
                com.atlas.entity.MonthlyAllocation existingMonthly = com.atlas.entity.MonthlyAllocation.builder()
                                .id(1L).year(2026).month(1).percentage(50).build();
                when(monthlyAllocationRepository.findByAllocationIdAndYearAndMonth(100L, 2026, 1))
                                .thenReturn(Optional.of(existingMonthly));
                ...
                // Then
                org.mockito.Mockito.verify(monthlyAllocationRepository, org.mockito.Mockito.times(0))
                                .delete(any());
        }

        @Test
        @DisplayName("getGroupedAllocations - PROSPECT filter with percentages should include allocations")
        void getGroupedAllocations_prospectFilterWithPercentages_shouldIncludeAllocations() {
                // Given
                com.atlas.entity.User mockUser = new com.atlas.entity.User();
                mockUser.setId(1L);
                when(employeeService.getAccessibleEmployeeIds(mockUser))
                ...
                Employee prospectEmp = Employee.builder()
                                .id(1L)
                                .oracleId(1000)
                                .name("Prospect Employee")
                                .email("prospect@atlas.com")
                ...
                when(employeeRepository.findAll(any(org.springframework.data.jpa.domain.Specification.class),
                                any(org.springframework.data.domain.Pageable.class)))
                                .thenReturn(new org.springframework.data.domain.PageImpl<>(
                                                java.util.List.of(prospectEmp)));

                Allocation prospectAllocation = Allocation.builder()
                                .id(600L)
                                .employee(prospectEmp)
                                .allocationType(Allocation.AllocationType.PROSPECT)
                ...
                // Then
                assertThat(result.getContent()).hasSize(1);
                assertThat(result.getContent().get(0).getEmployeeId()).isEqualTo(prospectEmp.getId());
                assertThat(result.getContent().get(0).getAllocations()).hasSize(1);
                assertThat(result.getContent().get(0).getAllocations().get(0).getAllocationType())
                                .isEqualTo(Allocation.AllocationType.PROSPECT);
        }
