 ...
 * Tests ensure that filter dropdowns correctly interact with each other and
 * main search results.
 */
...
public class FacetedSearchIntegrationTest extends RepositoryTestBase {
        ...
        class AllocationsPageFacetedSearchTests {
                ...
                void managerDropdownShouldUpdateWithAllocationTypeFilter() {
                        ...
                        // Then: manager1 should be in PROJECT managers (has employeeActive with
                        // PROJECT)
                ...
                void allocationTypeDropdownShouldUpdateWithEmployeeSearch() {
                        ...
                        List<Allocation.AllocationType> allTypes = allocationRepository
                                        .findDistinctAllocationTypesByManager(null);
                ...
                void managerDropdownShouldRespectEmployeeSearch() {
                        ...
                        // Note: employeeBench has no allocations, so won't appear in allocation-based
                        // search
        ...
        class CrossFilterConsistencyTests {
                ...
                void benchFilterShouldBeConsistent() {
                        ...
                        Page<Employee> benchEmployees = employeeRepository.findAll(
                ...
                void activeFilterShouldBeConsistent() {
                        ...
                        Page<Employee> activeEmployees = employeeRepository.findAll(
                                        com.atlas.specification.EmployeeSpecification.withFilters(
                ...
                void allocationTypeFilterShouldBeConsistent() {
                        ...
                        Page<Employee> maternityEmployees = employeeRepository.findAll(
                                        com.atlas.specification.EmployeeSpecification.withFilters(
                        ...
                        List<Allocation.AllocationType> types = allocationRepository
                                        .findDistinctAllocationTypesByManager(null);
        ...
        class ABACFilterIntegrationTests {
                ...
                void accessibleIdsShouldFilterConsistently() {
                        ...
                        Page<Employee> activeEmployees = employeeRepository.findAll(
                                        com.atlas.specification.EmployeeSpecification.withFilters(
                                                        null, null, null, "ACTIVE", accessibleIds, null, currentYear,
                                                        currentMonth),
                                        pageable);
                        ...
                        List<Employee> managers = employeeRepository
                                        .findDistinctManagersOfActiveByEmployeeSearchFiltered(
                ...
                void emptyAccessibleIdsShouldBeConsistent() {
                        ...
                        List<Employee> managers = employeeRepository
                                        .findDistinctManagersOfBenchByEmployeeSearchFiltered(
        ...
        class SearchInteractionTests {
                ...
                void employeeSearchShouldFilterBoth() {
                        ...
                        Page<Employee> activeEmployees = employeeRepository.findAll(
                                        com.atlas.specification.EmployeeSpecification.withFilters(
                                                        "multi", null, null, "ACTIVE", null, null, currentYear,
                                                        currentMonth),
                                        pageable);
