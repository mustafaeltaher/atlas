 ...
 * Tests cover all allocation status queries (BENCH, ACTIVE, PROSPECT) and
 * faceted search.
 */
...
public class EmployeeRepositoryTest extends RepositoryTestBase {
        ...
        class BenchEmployeeTests {
                ...
                void shouldFindBenchEmployees() {
                        ...
                        Page<Employee> result = employeeRepository.findAll(
                                        com.atlas.specification.EmployeeSpecification.withFilters(
                                                        null, null, null, "BENCH", null, null, currentYear,
                                                        currentMonth),
                                        pageable);

                        // Then: BENCH employees are returned (CEO, managers, and employeeBench have no
                        // allocations)
                        assertThat(result.getContent())
                                        .hasSize(5)
                                        .extracting(Employee::getEmail)
                                        .contains("bench@atlas.com", "ceo@atlas.com", "manager1@atlas.com",
                                                        "manager2@atlas.com", "pastprospect@atlas.com");
                }

                @Test
                @DisplayName("Should include employees in BENCH if their PROSPECT allocation is in the past")
                void shouldIncludeEmployeesWithPastProspectAllocationsInBench() {
                        // Given: employeePastProspect has a PROSPECT allocation that ended 3 months ago
                        Pageable pageable = PageRequest.of(0, 10);

                        // When: Query for BENCH employees in the CURRENT month
                        Page<Employee> result = employeeRepository.findAll(
                                        com.atlas.specification.EmployeeSpecification.withFilters(
                                                        null, null, null, "BENCH", null, null, currentYear,
                                                        currentMonth),
                        ...
                        // Then: The employee MUST be returned on the bench because their prospect
                        // allocation is over.
                        // THIS ASSERTS THE BUG FIX: If it fails, the unbounded PROSPECT subquery is
                        // still swallowing them.
                        assertThat(result.getContent())
                                        .extracting(Employee::getEmail)
                                        .contains("pastprospect@atlas.com");
                }
                ...
                void shouldFilterBenchEmployeesBySearch() {
                        ...
                        Page<Employee> result = employeeRepository.findAll(
                                        com.atlas.specification.EmployeeSpecification.withFilters(
                                                        "%bench%", null, null, "BENCH", null, null, currentYear,
                                                        currentMonth),
                                        pageable);
                        ...
                        result = employeeRepository.findAll(
                                        com.atlas.specification.EmployeeSpecification.withFilters(
                                                        "%nomatch%", null, null, "BENCH", null, null, currentYear,
                                                        currentMonth),
                                        pageable);
                ...
                void shouldFilterBenchEmployeesByManager() {
                        ...
                        Page<Employee> result = employeeRepository.findAll(
                                        com.atlas.specification.EmployeeSpecification.withFilters(
                                                        null, null, manager1.getId(), "BENCH", null, null, currentYear,
                                                        currentMonth),
                                        pageable);
                        ...
                        assertThat(result.getContent())
                                        .extracting(Employee::getEmail)
                                        .containsExactlyInAnyOrder("bench@atlas.com", "pastprospect@atlas.com");

                        // When: Filter by manager2
                        result = employeeRepository.findAll(
                                        com.atlas.specification.EmployeeSpecification.withFilters(
                                                        null, null, manager2.getId(), "BENCH", null, null, currentYear,
                                                        currentMonth),
                                        pageable);
                ...
                void shouldFilterBenchEmployeesByAccessibleIds() {
                        ...
                        Page<Employee> result = employeeRepository.findAll(
                                        com.atlas.specification.EmployeeSpecification.withFilters(
                                                        null, null, null, "BENCH", accessibleIds, null, currentYear,
                                                        currentMonth),
                                        pageable);
                ...
                void shouldCountBenchEmployees() {
                        ...
                        long count = employeeRepository.countBenchEmployeesFiltered(null, currentYear, currentMonth);

                        // Then: Count is 4 (CEO, manager1, manager2, employeeBench all have no
                        // allocations)
                ...
                void shouldCountBenchEmployeesWithAccessibleIds() {
                        ...
                        long count = employeeRepository.countBenchEmployeesFiltered(accessibleIds, currentYear,
                                        currentMonth);
        ...
        class ActiveEmployeeTests {
                ...
                void shouldFindActiveEmployees() {
                        // Given: employeeActive and employeeMultipleProjects have active PROJECT
                        // allocations
                        Pageable pageable = PageRequest.of(0, 10);
                        ...
                        Page<Employee> result = employeeRepository.findAll(
                                        com.atlas.specification.EmployeeSpecification.withFilters(
                                                        null, null, null, "ACTIVE", null, null, currentYear,
                                                        currentMonth),
                                        pageable);
                ...
                void shouldFilterActiveEmployeesBySearch() {
                        ...
                        Page<Employee> result = employeeRepository.findAll(
                                        com.atlas.specification.EmployeeSpecification.withFilters(
                                                        "%active%", null, null, "ACTIVE", null, null, currentYear,
                                                        currentMonth),
                                        pageable);
                ...
                void shouldFilterActiveEmployeesByManager() {
                        ...
                        Page<Employee> result = employeeRepository.findAll(
                                        com.atlas.specification.EmployeeSpecification.withFilters(
                                                        null, null, manager1.getId(), "ACTIVE", null, null, currentYear,
                                                        currentMonth),
                                        pageable);
                        ...
                        result = employeeRepository.findAll(
                                        com.atlas.specification.EmployeeSpecification.withFilters(
                                                        null, null, manager2.getId(), "ACTIVE", null, null, currentYear,
                                                        currentMonth),
                                        pageable);
                ...
                void shouldCountActiveEmployees() {
                        ...
                        long count = employeeRepository.countActiveAllocatedEmployeesFiltered(null, currentYear,
                                        currentMonth);
        ...
        class ProspectEmployeeTests {
                ...
                void shouldFindProspectEmployees() {
                        ...
                        Page<Employee> result = employeeRepository.findAll(
                                        com.atlas.specification.EmployeeSpecification.withFilters(
                                                        null, null, null, "PROSPECT", null, null, currentYear,
                                                        currentMonth),
                                        pageable);
                ...
                void shouldFilterProspectEmployeesBySearch() {
                        ...
                        Page<Employee> result = employeeRepository.findAll(
                                        com.atlas.specification.EmployeeSpecification.withFilters(
                                                        "%prospect%", null, null, "PROSPECT", null, null, currentYear,
                                                        currentMonth),
                                        pageable);
                ...
                void shouldCountProspectEmployees() {
                        ...
                        long count = employeeRepository.countProspectEmployeesFiltered(null, currentYear, currentMonth);
        ...
        class AllocationTypeTests {
                ...
                void shouldFindEmployeesByMaternityType() {
                        ...
                        Page<Employee> result = employeeRepository.findAll(
                                        com.atlas.specification.EmployeeSpecification.withFilters(
                                                        null, null, null, "MATERNITY", null, null, currentYear,
                                                        currentMonth),
                                        pageable);
                ...
                void shouldFindEmployeesByVacationType() {
                        ...
                        Page<Employee> result = employeeRepository.findAll(
                                        com.atlas.specification.EmployeeSpecification.withFilters(
                                                        null, null, null, "VACATION", null, null, currentYear,
                                                        currentMonth),
                                        pageable);
                ...
                void shouldFindEmployeesByProjectType() {
                        ...
                        Page<Employee> result = employeeRepository.findAll(
                                        com.atlas.specification.EmployeeSpecification.withFilters(
                                                        null, null, null, "PROJECT", null, null, currentYear,
                                                        currentMonth),
                                        pageable);
        ...
        class DashboardTests {
                ...
                void shouldCountActiveEmployees() {
                        ...
                        assertThat(count).isEqualTo(10); // All except employeeResigned
                }
                ...
                void shouldCalculateAverageAllocation() {
                        ...
                        // Then: Average is 100% (employeeActive=100%, employeeMultipleProjects=100%
                        // total)
        ...
        class EdgeCaseTests {
                ...
                void shouldExcludeResignedEmployees() {
                        ...
                        Page<Employee> benchResult = employeeRepository.findAll(
                                        com.atlas.specification.EmployeeSpecification.withFilters(
                                                        null, null, null, "BENCH", null, null, currentYear,
                                                        currentMonth),
                                        pageable);
                        ...
                        Page<Employee> activeResult = employeeRepository.findAll(
                                        com.atlas.specification.EmployeeSpecification.withFilters(
                                                        null, null, null, "ACTIVE", null, null, currentYear,
                                                        currentMonth),
                                        pageable);
                ...
                void shouldHandleEmptyAccessibleIds() {
                        ...
                        Page<Employee> result = employeeRepository.findAll(
                                        com.atlas.specification.EmployeeSpecification.withFilters(
                                                        null, null, null, "BENCH", emptyIds, null, currentYear,
                                                        currentMonth),
                                        pageable);
